<template>
  <div class="2xl:container my-0 mx-auto">
    ...
    <div class="flex justify-center items-center gap-5 mb-[110px]">
      <button :disabled="page == 1" @click="goToPreviousPage" class="disabled:cursor-not-allowed rounded-[100px] border-[#BCBCBC] border active:border-[#E31E25] fill-[#E31E25] active:fill-white active:bg-[#E31E25] cursor-pointer">
      ...
      <div class="rounded-[100px] w-[64px] h-[64px] flex justify-center items-center border-[#E31E25] bg-[#E31E25] border cursor-pointer">
        <span class="text-[18px] text-white font-extrabold">{{ page }}</span>
      </div>
      <button :disabled="page == 3" @click="goToNextPage" class="disabled:cursor-not-allowed rounded-[100px] border-[#BCBCBC] border active:border-[#E31E25] fill-[#E31E25] active:fill-white active:bg-[#E31E25] cursor-pointer">
